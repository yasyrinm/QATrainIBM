...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed login field email empty')).toString()

assert Result.equals('Email or IBMid is required')
