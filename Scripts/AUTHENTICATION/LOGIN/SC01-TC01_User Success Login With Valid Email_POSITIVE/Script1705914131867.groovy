...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Email'), 'Yasyrinm@gmail.com')
...
//Verify succes to login

def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify Login Succes')).toString()

assert Result.equals('Enter code sent to your email')
