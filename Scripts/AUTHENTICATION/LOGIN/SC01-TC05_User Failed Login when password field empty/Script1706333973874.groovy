...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Email'), 'semestaprawira@gmail.com')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed login password field empty')).toString()

assert Result.equals('Password required')
