...
//User Failed create IBMid when password more than 63 characters
...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Password_Regis'), 'Aku@awdnawkbdawkdbawhkbdakhwbdahwvdhawvdjahwdvajwhvdjawvdahwjvdhjawdajwhvdjawvdajwhvdawhvdhjawvdhawkvdhawkvdahwvdahwkbdaw')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed create account when password more than 63 characters')).toString()

assert Result.equals('Password should have maximum of 63 characters')