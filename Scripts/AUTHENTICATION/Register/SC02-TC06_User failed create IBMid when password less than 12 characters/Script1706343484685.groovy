...
//User Failed create IBMid when password less than 12 characters
...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Password_Regis'), 'Aku@')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed create IBMid when password less than 12 characters')).toString()

assert Result.equals('12 characters minimum')
