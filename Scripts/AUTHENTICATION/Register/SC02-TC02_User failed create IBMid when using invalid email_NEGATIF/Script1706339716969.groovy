...
//User Failed create IBMid using invalid email
...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Email_regis'), 'prawirasemesta.com')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed create IBMid when using invalid email')).toString()

assert Result.equals('Suggested format (name@company.com)')
