...
//User Failed create IBMid because invalid last name
...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Nama Belakang'), 'asepakdbawkdbawudbaiuwdbauwidbauiwbdauiwbduawibdauwdbaiwbdauiwbdauiwbduawbdawida')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed create account because invalid last name')).toString()

assert Result.equals('Last name should have maximum of 35 characters')
