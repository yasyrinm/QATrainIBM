...
//User Failed create IBMid when password not contain 1 lowercase letters
...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Password_Regis'), 'RAIHANTAMPAN123@')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed create IBMid when password not contain 1 lowercase letters')).toString()

assert Result.equals('Password must contain at least one lowercase character.')
