...
//User User failed create IBMid when Dropdown country not selected
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify failed create IBMid when User not Selected Dropdown Negara atau wilayah tempat tinggal')).toString()

assert Result.equals('Country is required')
