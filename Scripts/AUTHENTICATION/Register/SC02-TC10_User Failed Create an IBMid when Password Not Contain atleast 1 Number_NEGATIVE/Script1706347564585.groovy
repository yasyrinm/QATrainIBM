...
//User Failed create IBMid when password not contain 1 number
...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Password_Regis'), 'Raihantampannnn@')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify create IBMid when password not contain 1 number')).toString()

assert Result.equals('Password must contain at least one number.')
