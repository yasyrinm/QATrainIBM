...
//User Failed create IBMid using email that already registered
...
WebUI.setText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Input Email_regis'), 'yasyrinm@gmail.com')
...
def Result = WebUI.getText(findTestObject('Object Repository/AUTHENTICATION/LOGIN_Register/Verify Failed create account with email already registered')).toString()

assert Result.equals('This email is associated with an IBM account Log in')
